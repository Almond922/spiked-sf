...
const AuthPages: React.FC = () => {
    ...
    const handleSignupSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // On successful signup, show a success message and switch to the login view
            setSuccessMessage('Signup successful! Please check your email to verify your account, then sign in.');
            setIsLogin(true);
            setFormData({ firstName: '', lastName: '', email: '', password: '', confirmPassword: '' }); // Clear sign up form
            setLoginData({ email: formData.email, password: ''}); // Pre-fill email in login form
        ...
        <div className="h-screen overflow-hidden md:grid md:grid-cols-2">
            ...
            <div className="max-w-md">
                ...
                <div className="relative">
                    ...
                    src="/logo.png"
                    alt="SpikedAI Logo"
                    className="w-24 h-24 shadow-lg object-cover"
                ...
                Unlock AI-powered insights and create smarter solutions. Sign in or
                create an account to get started with SpikedAI.
                </p>
            </div>
            </div>
                ...
                <div className="w-full max-w-md">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10">
                        <div className="text-center mb-10">
                            <h1 className="text-3xl font-semibold text-gray-900 mb-3">{isLogin ? 'Welcome back' : 'Create account'}</h1>
                            <p className="text-gray-600 text-lg">{isLogin ? 'Please sign in to your account' : 'Get started with your free account'}</p>
                        </div>
                        ...
                        {isLogin ? (
                            <form onSubmit={handleLoginSubmit} className="space-y-6" noValidate>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" className="text-sm text-gray-900 hover:text-gray-700 font-medium">Forgot password?</button>
                                </div>
                                <button type="submit" disabled={isLoading} className="w-full bg-gray-900 text-white py-3.5 px-4 rounded-lg font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200">
                        ...
                        <div className="text-center mt-8">
                            <p className="text-gray-600">
                                ...
                                <button type="button" onClick={() => { setIsLogin(!isLogin); setErrors({}); setApiError(null); setSuccessMessage(null); }} className="font-medium text-gray-900 hover:text-gray-700 underline">
