    ...
    return (
        <div className="app-layout min-h-screen flex flex-col">
            ...
            <AppHeader 
                ...
                // NOTE: Removed unused local state props (showDocuments, setShowDocuments) from MainLayout 
                // since NavBar.tsx manages the document sidebar's visibility internally.
            />
