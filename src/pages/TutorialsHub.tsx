...
const TutorialsHub: React.FC = () => {
              ...
              subQuestions: [
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">The sign-up process in <strong>spikedAI</strong> is quick and straightforward. Follow these steps to get started:</p>
  ...
  />
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Email verification is a crucial step to activate your spikedAI account. Here's what you need to do:</p>
  ...
  />
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;"><strong>spikedAI</strong> allows flexible password creation, but we strongly recommend following security best practices.</p>
                      ...
                      <ul style="margin:0;padding-left:24px;list-style-type:none;">
                        <li style="margin-bottom:8px;padding-left:8px;font-family:monospace;">✓ SpikedAI2025! — <span style="color:#059669;">Strong</span></li>
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      ...
                      <p style="margin:0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                        <strong>Note:</strong> Verification emails typically arrive within <strong>1-2 minutes</strong>. Wait a few moments before requesting a resend.
                      </p>
                    </div>
                  `
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      ...
                      <p style="margin-bottom:20px;">This policy ensures account security and prevents duplicate registrations. If you need to create another account, you'll need to use a different email address.</p>
              ...
              subQuestions: [
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Access your spikedAI workspace using your registered credentials:</p>
                      
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Navigate to the <strong>Sign In</strong> page</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your registered <strong>Email Address</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your <strong>Password</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">(Optional) Enable <strong>Remember Me</strong> to stay logged in on this device</li>
                        <li style="margin-bottom:0;padding-left:8px;">Click <strong>Sign In</strong> to access your dashboard</li>
                      </ol>

                      <p style="margin-bottom:24px;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                        <strong>Security Tip:</strong> Only use <strong>Remember Me</strong> on your personal devices, not on shared or public computers.
                      </p>
  ...
  />
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Sign in faster with your Google account — no password required:</p>
                      
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Click the <strong>Sign in with Google</strong> button</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Select your Google account from the popup</li>
                        <li style="margin-bottom:0;padding-left:8px;">Grant spikedAI access when prompted</li>
                      </ol>

                      <p style="margin-bottom:8px;font-weight:600;">Benefits of Google Sign-In:</p>
                      <ul style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Faster login</strong> — no need to remember passwords</li>
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>More secure</strong> — protected by Google's security</li>
                        <li style="margin-bottom:0;padding-left:8px;"><strong>One-click access</strong> — seamless authentication</li>
                      </ul>
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Reset your password in just a few simple steps:</p>
                      
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Click <strong>Forgot Password?</strong> on the sign-in page</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your registered email address</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click <strong>Send Reset Link</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Check your email for the password reset link</li>
                        <li style="margin-bottom:0;padding-left:8px;">Click the link and create a new password</li>
                      </ol>
  ...
  />
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">If you're experiencing login issues, try these solutions:</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">Common troubleshooting steps:</p>
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Verify your account is <strong>email-verified</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Double-check for <strong>typos</strong> in your email or password</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Try signing in from a <strong>different browser</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Clear your browser <strong>cache and cookies</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Disable browser extensions temporarily</li>
                        <li style="margin-bottom:0;padding-left:8px;">If you see an <strong>"Invalid Credentials"</strong> message, use the password reset option</li>
                      </ol>

                      <p style="margin:0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                        <strong>Still need help?</strong> Contact our support team at <strong>support@spiked.ai</strong> — we're here to help!
                      </p>
                    </div>
                  `
                }
              ...
              subQuestions: [
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">The Setup Profile section is your personal account control center where you can manage all your profile information and settings.</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">You can manage the following:</p>
                      <ul style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Personal Information</strong> — Update your first name and last name</li>
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Email Address</strong> — View your registered email (contact support to change)</li>
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Password</strong> — Reset or change your account password</li>
                        <li style="margin-bottom:0;padding-left:8px;"><strong>Profile Picture</strong> — Upload or update your profile image (if applicable)</li>
                      </ul>
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Updating your name in spikedAI is simple and takes just a few seconds:</p>
                      
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Go to <strong>Settings → Profile</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click on the <strong>Edit Profile</strong> button</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click on the name field you want to update (First Name or Last Name)</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your new name</li>
                        <li style="margin-bottom:0;padding-left:8px;">Click <strong>Save Changes</strong> to apply the update</li>
                      </ol>
  ...
  />
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Your registered email address is permanently linked to your spikedAI account for security purposes and cannot be changed directly through the settings.</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">To update your email address:</p>
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Navigate to <strong>Settings → Help & Support</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click on <strong>Contact Support</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Submit a request to change your email address</li>
                        <li style="margin-bottom:0;padding-left:8px;">Our support team will verify your identity and process the change</li>
                      </ol>
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">You can change your password anytime from your profile settings:</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">Method 1: From Profile Settings</p>
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Go to <strong>Settings → Security</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click on <strong>Change Password</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your <strong>current password</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your <strong>new password</strong> and confirm it</li>
                        <li style="margin-bottom:0;padding-left:8px;">Click <strong>Update Password</strong> to save</li>
                      </ol>

                      <p style="margin-bottom:12px;font-weight:600;">Method 2: Password Reset (if you forgot your password)</p>
                      <ol style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:12px;padding-left:8px;">Go to the login page</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Click <strong>Forgot Password?</strong></li>
                        <li style="margin-bottom:12px;padding-left:8px;">Enter your registered email</li>
                        <li style="margin-bottom:12px;padding-left:8px;">Check your email for the reset link</li>
                        <li style="margin-bottom:0;padding-left:8px;">Create a new password through the link</li>
                      </ol>
  ...
  />
                ...
                {
                  id: 'unsaved-changes',
                  question: 'What happens if I dont save my changes?',
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">If you make changes to your profile but don't click the <strong>Save Changes</strong> button, your modifications will not be applied.</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">What happens to unsaved changes:</p>
                      <ul style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:10px;padding-left:8px;">If you navigate away from the page, all unsaved changes will be lost</li>
                        <li style="margin-bottom:10px;padding-left:8px;">If you refresh the page, your previous saved details will remain unchanged</li>
                        <li style="margin-bottom:10px;padding-left:8px;">If you close the browser, no changes will be saved</li>
                        <li style="margin-bottom:0;padding-left:8px;">You may see a warning popup asking you to confirm before leaving (depending on your browser)</li>
                      </ul>
                ...
                },
                {
                  ...
                  answer: `
                    <div style="line-height:1.8;color:#374151;font-size:15px;">
                      <p style="margin-bottom:20px;">Yes, you can refresh your profile settings anytime. This is useful if you want to discard unsaved changes or reload your current saved information.</p>
                      
                      <p style="margin-bottom:12px;font-weight:600;">Ways to refresh your profile:</p>
                      <ul style="margin:0 0 24px 0;padding-left:24px;">
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Browser Refresh</strong> — Press F5 or click the refresh button in your browser</li>
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Cancel Button</strong> — Click the <strong>Cancel</strong> button (if available) to discard changes</li>
                        <li style="margin-bottom:10px;padding-left:8px;"><strong>Navigate Away</strong> — Go to another section and return to profile settings</li>
                        <li style="margin-bottom:0;padding-left:8px;"><strong>Reload Option</strong> — Use the reload/reset button if provided in the UI</li>
                      </ul>

                      <p style="margin-bottom:24px;">Refreshing will reload your last saved profile information and discard any unsaved edits you've made.</p>
          ...
          subQuestions: [
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">Personalization settings are located in the main console and must be configured <strong>before starting a meeting</strong>.</p>
                  
                  <p style="margin-bottom:12px;font-weight:600;">How to access:</p>
                  <ol style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:12px;padding-left:8px;">Go to the <strong>Main Console</strong></li>
                    <li style="margin-bottom:12px;padding-left:8px;">Click on <strong>Personalization</strong> in the navigation menu</li>
                    <li style="margin-bottom:0;padding-left:8px;">Configure your settings before joining or starting a meeting</li>
                  </ol>
...
/>
            ...
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">Bot Configuration allows you to customize the visible identity of your AI copilot during meetings.</p>
                  
                  <p style="margin-bottom:12px;font-weight:600;">Current settings:</p>
                  <ul style="margin:0 0 20px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Default name: <strong>SpikedAI</strong></li>
                    <li style="margin-bottom:0;padding-left:8px;">Name customization is <strong>currently not available</strong> but will be implemented in future updates</li>
                  </ul>
            ...
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">Customer Persona determines your AI's communication style, depth, and focus during meetings. Choose the persona that best matches your audience.</p>
                  
                  <p style="margin-bottom:12px;font-weight:600;">Available Personas:</p>
                  
                  <div style="border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:12px;background:#fefefe;">
                    <p style="margin:0 0 8px 0;font-weight:600;color:#111827;font-size:15px;">📊 Balanced</p>
                    <p style="margin:0;color:#6b7280;font-size:14px;">Versatile profile for general business users in B2B settings. Provides well-rounded responses suitable for mixed audiences.</p>
                  </div>

                  <div style="border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:12px;background:#fefefe;">
                    <p style="margin:0 0 8px 0;font-weight:600;color:#111827;font-size:15px;">⚙️ Technical</p>
                    <p style="margin:0;color:#6b7280;font-size:14px;">Deep technical jargon-friendly responses. Perfect for engineering teams and technical stakeholders who need detailed specifications.</p>
                  </div>

                  <div style="border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:12px;background:#fefefe;">
                    <p style="margin:0 0 8px 0;font-weight:600;color:#111827;font-size:15px;">💰 Financial</p>
                    <p style="margin:0;color:#6b7280;font-size:14px;">ROI-driven, cost-benefit analysis focused. Ideal for CFOs, finance teams, and budget-conscious decision makers.</p>
                  </div>

                  <div style="border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:24px;background:#fefefe;">
                    <p style="margin:0 0 8px 0;font-weight:600;color:#111827;font-size:15px;">👔 Business Executive</p>
                    <p style="margin:0;color:#6b7280;font-size:14px;">Layman operational clarity with strategic high-impact insights. Best for C-suite executives who need concise, actionable information.</p>
                  </div>

                  <p style="margin-bottom:12px;font-weight:600;">How to set your persona:</p>
                  <ol style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Navigate to <strong>Personalization → Customer Persona</strong></li>
                    <li style="margin-bottom:10px;padding-left:8px;">Select the persona that matches your meeting audience</li>
                    <li style="margin-bottom:0;padding-left:8px;">The AI will automatically adjust its tone and depth accordingly</li>
                  </ol>
...
/>
            ...
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;"><strong>Meeting Focus</strong> is one of the most critical features in spikedAI. It tells your AI what to prioritize and track during the meeting.</p>
                  
                  <div style="padding:20px;background:#FEF3C7;border-left:4px solid #F59E0B;border-radius:8px;margin-bottom:24px;">
                    <p style="margin:0;font-weight:600;color:#92400E;font-size:15px;">⚠️ IMPORTANT:</p>
                    <p style="margin:8px 0 0 0;color:#92400E;font-size:14px;">Meeting Focus <strong>must be set before starting a meeting</strong>. This ensures your AI is prepared to capture the right insights from the very beginning.</p>
                  </div>

                  <p style="margin-bottom:12px;font-weight:600;">Why Meeting Focus matters:</p>
                  <ul style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Directs your AI's attention to what matters most</li>
                    <li style="margin-bottom:10px;padding-left:8px;">Ensures relevant insights are captured and summarized</li>
                    <li style="margin-bottom:10px;padding-left:8px;">Improves the quality of post-meeting reports</li>
                    <li style="margin-bottom:0;padding-left:8px;">Helps track specific objectives and outcomes</li>
                  </ul>

                  <p style="margin-bottom:12px;font-weight:600;">How to set Meeting Focus:</p>
                  <ol style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Go to <strong>Personalization → Meeting Focus</strong></li>
                    <li style="margin-bottom:10px;padding-left:8px;">Define what the meeting is about (e.g., "Product Demo", "Sales Discovery", "Technical Q&A")</li>
                    <li style="margin-bottom:10px;padding-left:8px;">Specify key topics to track</li>
                    <li style="margin-bottom:0;padding-left:8px;">Save before joining the meeting</li>
                  </ol>
...
/>
            ...
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">The System Prompt is the underlying instruction set that guides your AI's behavior during meetings.</p>
                  
                  <p style="margin-bottom:12px;font-weight:600;">How System Prompt works:</p>
                  <ul style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;"><strong>Automatic Mode:</strong> The system prompt is automatically generated based on your chosen Customer Persona</li>
                    <li style="margin-bottom:10px;padding-left:8px;"><strong>Custom Mode:</strong> You can write your own system prompt to fine-tune AI behavior</li>
                  </ul>

                  <p style="margin-bottom:12px;font-weight:600;">When to customize:</p>
                  <ul style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">You need very specific AI behavior not covered by default personas</li>
                    <li style="margin-bottom:10px;padding-left:8px;">You want to add company-specific guidelines</li>
                    <li style="margin-bottom:10px;padding-left:8px;">You have unique meeting requirements</li>
                  </ul>

                  <p style="margin-bottom:12px;font-weight:600;">How to customize:</p>
                  <ol style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Navigate to <strong>Personalization → System Prompt</strong></li>
                    <li style="margin-bottom:10px;padding-left:8px;">Write your custom instructions</li>
                    <li style="margin-bottom:0;padding-left:8px;">Save and test in a practice meeting</li>
                  </ol>

                  <p style="margin:0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                    <strong>Tip:</strong> Start with the automatic system prompt and only customize if you need very specific behavior.
                  </p>
                </div>
              `
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">Answering Styles determine how your AI formats and delivers responses during meetings. You can select multiple styles to suit different needs.</p>
                  
                  <p style="margin-bottom:12px;font-weight:600;">Available Answering Styles:</p>
                  
                  <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:24px;">
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                    ...
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      ...
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Detailed, comprehensive explanations</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                    ...
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      ...
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Explain using relatable comparisons</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">⚙️ Different Technical Term</p>
                    ...
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      ...
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Highlight value propositions</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">📊 Key Statistics</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Include relevant data and metrics</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">📖 Case Study Summary</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Reference similar success stories</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">⚔️ Competitive Comparison</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Compare with alternatives</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">❓ Anticipated Customer Questions</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Address potential concerns</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">ℹ️ Information Gap</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Identify missing information</p>
                    </div>
                    <div style="border:1px solid #e5e7eb;border-radius:6px;padding:12px;background:#fefefe;">
                      <p style="margin:0;font-weight:600;color:#111827;font-size:14px;">💵 Pricing Overview</p>
                      <p style="margin:4px 0 0 0;color:#6b7280;font-size:13px;">Provide cost breakdowns</p>
                    </div>
                  </div>

                  <p style="margin-bottom:12px;font-weight:600;">How to select answering styles:</p>
                  <ol style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Go to <strong>Personalization → Answering Styles</strong></li>
                    <li style="margin-bottom:10px;padding-left:8px;">Check the boxes for styles that match your meeting needs</li>
                    <li style="margin-bottom:0;padding-left:8px;">You can select multiple styles simultaneously</li>
                  </ol>
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <div style="padding:20px;background:#DBEAFE;border-left:4px solid #2563EB;border-radius:8px;margin-bottom:24px;">
                    <p style="margin:0;font-weight:600;color:#1E40AF;font-size:15px;">🎯 CRITICAL REQUIREMENT</p>
                    <p style="margin:8px 0 0 0;color:#1E3A8A;font-size:14px;"><strong>Yes, Custom Goals are mandatory for new users joining a meeting.</strong> You must add at least one custom goal before starting your first meeting.</p>
                  </div>

                  <p style="margin-bottom:20px;">Custom Goals tell your AI what specific outcomes and objectives to track throughout the meeting. They ensure your AI captures what matters most to you.</p>

                  <p style="margin-bottom:12px;font-weight:600;">Why Custom Goals are important:</p>
                  <ul style="margin:0 0 24px 0;padding-left:24px;">
                    <li style="margin-bottom:10px;padding-left:8px;">Ensures AI focuses on your specific meeting objectives</li>
                    <li style="margin-bottom:10px;padding-left:8px;">Helps generate relevant post-meeting summaries</li>
                    <li style="margin-bottom:10px;padding-left:8px;">Tracks measurable outcomes automatically</li>
                    <li style="margin-bottom:0;padding-left:8px;">Improves follow-up action items</li>
                  </ul>

                  <p style="margin-bottom:20px;">For detailed information on how to create and manage Custom Goals, please refer to our dedicated Custom Goals tutorial:</p>

                  <a href="#custom-goals-section"
  style="display:inline-flex;align-items:center;gap:8px;padding:12px 20px;background:#2563EB;color:white;text-decoration:none;border-radius:8px;font-weight:600;font-size:14px;transition:background 0.2s;"
  onmouseover="this.style.background='#1D4ED8'"
  onmouseout="this.style.background='#2563EB'">
  Learn About Custom Goals
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="m12 5 7 7-7 7" />
                  ...
                  <p style="margin:24px 0 0 0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                    <strong>First-time users:</strong> The system will prompt you to create a Custom Goal if you haven't set one up yet. Take a moment to define your goals before joining your first meeting.
                  </p>
                </div>
              `
            },
            {
              ...
              answer: `
                <div style="line-height:1.8;color:#374151;font-size:15px;">
                  <p style="margin-bottom:20px;">Use this checklist to ensure you've configured all personalization settings before your meeting:</p>
                  
                  <div style="border:1px solid #e5e7eb;border-radius:8px;padding:24px;background:#fefefe;margin-bottom:24px;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:12px;">
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        ...
                        <span style="color:#374151;font-size:14px;"><strong>Bot Configuration:</strong> Verify your AI copilot name (currently Spike.di)</span>
                      </label>
                      
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        <input type="checkbox" style="margin-top:4px;" />
                        <span style="color:#374151;font-size:14px;"><strong>Customer Persona:</strong> Select appropriate persona (Balanced/Technical/Financial/Business Executive)</span>
                      </label>
                      
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        <input type="checkbox" style="margin-top:4px;" />
                        <span style="color:#374151;font-size:14px;"><strong>Meeting Focus:</strong> ⚠️ Define what the meeting is about and key topics to track</span>
                      </label>
                      
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        <input type="checkbox" style="margin-top:4px;" />
                        <span style="color:#374151;font-size:14px;"><strong>System Prompt:</strong> Review automatic prompt or customize if needed</span>
                      </label>
                      
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        <input type="checkbox" style="margin-top:4px;" />
                        <span style="color:#374151;font-size:14px;"><strong>Answering Styles:</strong> Select relevant styles from the 12 available options</span>
                      </label>
                      
                      <label style="display:flex;align-items:start;gap:10px;cursor:pointer;">
                        <input type="checkbox" style="margin-top:4px;" />
                        <span style="color:#374151;font-size:14px;"><strong>Custom Goals:</strong> 🎯 Add at least one custom goal (mandatory for new users)</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div style="padding:20px;background:#FEF3C7;border-left:4px solid #F59E0B;border-radius:8px;">
                    ...
                    <p style="margin:8px 0 0 0;color:#92400E;font-size:13px;">Save your personalization settings as templates for recurring meeting types. This saves time and ensures consistency across similar meetings.</p>
                  </div>
                </div>
              `
            }
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <div style="padding:20px;background:#EFF6FF;border-left:4px solid #2563EB;border-radius:8px;margin-bottom:24px;">
...
<img
  ...
  />
        ...
        {
          id: 'theme-sync',
          question: 'Does SpikedAI follow my system theme?',
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              <p style="margin-bottom:20px;">Currently, SpikedAI uses <strong>manual theme selection</strong> rather than automatically syncing with your system preferences.</p>
              
              <p style="margin-bottom:12px;font-weight:600;">How it works:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">You manually choose between Light or Dark mode in Settings</li>
                <li style="margin-bottom:10px;padding-left:8px;">Your selection remains active regardless of your device's system theme</li>
                <li style="margin-bottom:0;padding-left:8px;">This gives you full control over your SpikedAI appearance</li>
              </ul>

              <div style="padding:20px;background:#FEF3C7;border-left:4px solid #F59E0B;border-radius:8px;margin-bottom:24px;">
                <p style="margin:0;font-weight:600;color:#92400E;font-size:14px;">🔔 Coming Soon</p>
                <p style="margin:8px 0 0 0;color:#92400E;font-size:13px;">We're working on adding an "Auto" theme option that will sync with your device's system preferences. Stay tuned for this update!</p>
              </div>

              <p style="margin-bottom:12px;font-weight:600;">Current theme options:</p>
              <ul style="margin:0;padding-left:24px;">
                <li style="margin-bottom:8px;padding-left:8px;"><strong>Light Mode</strong> – Always displays light theme</li>
                <li style="margin-bottom:0;padding-left:8px;"><strong>Dark Mode</strong> – Always displays dark theme</li>
              </ul>
            </div>
          `
        },
        ...
        },
        {
          ...
          question: 'What if my theme doesnt change?',
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
          ...
          subQuestions: [
            {
              ...
              answer: `Yes. Go to <strong>Settings → Security → Change Password</strong> and follow the steps.`
            },
            {
              id: 'two-factor',
              question: 'Does spikedAI support two-factor authentication?',
              answer: `Two-factor authentication (2FA) is coming soon as part of our advanced security update.`
            }
          ]
        }
      ]
  ...
  questions: [
    {
      ...
      subQuestions: [
        ...
        {
          id: 'hot-mic-feature',
          question: 'What is the Hot Mic feature?',
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              <p style="margin-bottom:20px;">The <strong>Hot Mic</strong> feature is an upcoming functionality that will allow enhanced audio control during meetings.</p>
              
              <div style="padding:20px;background:#FEF3C7;border-left:4px solid #F59E0B;border-radius:8px;margin-bottom:24px;">
                <p style="margin:0;font-weight:600;color:#92400E;font-size:14px;">🚧 Development Status</p>
                <p style="margin:8px 0 0 0;color:#92400E;font-size:13px;">The Hot Mic feature is currently <strong>not available</strong> but is actively in development. We're working on implementing this feature in a future release.</p>
              </div>

              <p style="margin-bottom:12px;font-weight:600;">What to expect (coming soon):</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Enhanced microphone controls during live meetings</li>
                <li style="margin-bottom:10px;padding-left:8px;">Advanced audio processing options</li>
                <li style="margin-bottom:0;padding-left:8px;">Improved real-time audio feedback</li>
              </ul>

              <p style="margin:0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                <strong>Stay Updated:</strong> We'll announce the Hot Mic feature launch through our product updates and release notes.
              </p>
            </div>
          `
        },
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <div style="border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:12px;background:#fefefe;">
                <p style="margin:0 0 8px 0;font-weight:600;color:#111827;font-size:15px;">🗑️ Delete Button</p>
                <p style="margin:0;color:#6b7280;font-size:14px;line-height:1.6;">Clear individual questions or your entire conversation history when needed.</p>
              </div>
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                ...
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Transcription References:</strong> Links to relevant meeting transcriptions</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Answer Verification:</strong> Verify the accuracy of AI-provided information</li>
                <li style="margin-bottom:0;padding-left:8px;"><strong>Quick Navigation:</strong> Jump directly to source material for deeper context</li>
              </ul>
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Chat Panel:</strong> All conversation messages</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Transcription Panel:</strong> Live meeting transcriptions</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Smart Suggestions Panel:</strong> AI insights and recommendations</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>AI Copilot Panel:</strong> Question and answer interface</li>
                <li style="margin-bottom:0;padding-left:8px;"><strong>Additional Panels:</strong> Any other enabled features</li>
              </ul>
...
/>
              ...
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Monitoring all aspects of your meeting simultaneously</li>
                <li style="margin-bottom:10px;padding-left:8px;">Users with large screens or multiple monitors</li>
                <li style="margin-bottom:10px;padding-left:8px;">Meetings where you need quick access to all features</li>
                <li style="margin-bottom:0;padding-left:8px;">Power users who want maximum information density</li>
              </ul>
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Chat Emphasized:</strong> Chat panel is larger and more prominent</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>All Panels Available:</strong> Other features remain accessible but smaller</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Balanced View:</strong> Focus on conversation without losing overview</li>
...
/>
              ...
              <p style="margin-bottom:12px;font-weight:600;">Best for:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Active participation in meeting conversations</li>
                <li style="margin-bottom:10px;padding-left:8px;">When you need to respond quickly in chat</li>
                <li style="margin-bottom:10px;padding-left:8px;">Balancing conversation focus with feature access</li>
                <li style="margin-bottom:0;padding-left:8px;">Most common meeting scenarios</li>
              </ul>
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Chat Panel:</strong> Full conversation interface</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Smart Suggestions Panel:</strong> Meeting Questions, sentiment, buying signals, and playbook</li>
              </ul>

              <p style="margin-bottom:12px;font-weight:600;">What's hidden:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Transcription panel</li>
                <li style="margin-bottom:10px;padding-left:8px;">AI Copilot panel</li>
                <li style="margin-bottom:0;padding-left:8px;">Other auxiliary features</li>
              </ul>
...
/>
              ...
              <p style="margin-bottom:12px;font-weight:600;">Best for:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Sales and client meetings where sentiment tracking is crucial</li>
                <li style="margin-bottom:10px;padding-left:8px;">When you want AI insights without extra clutter</li>
                <li style="margin-bottom:10px;padding-left:8px;">Smaller screens or laptops with limited space</li>
                <li style="margin-bottom:0;padding-left:8px;">Users who primarily interact through chat with AI support</li>
              </ul>
        ...
        },
        {
          ...
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              ...
              <p style="margin-bottom:12px;font-weight:600;">What's visible:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:0;padding-left:8px;"><strong>Chat Panel Only:</strong> Full-screen conversation interface</li>
              </ul>

              <p style="margin-bottom:12px;font-weight:600;">What's hidden:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Smart Suggestions panel</li>
                <li style="margin-bottom:10px;padding-left:8px;">Transcription panel</li>
                <li style="margin-bottom:10px;padding-left:8px;">AI Copilot panel</li>
                <li style="margin-bottom:0;padding-left:8px;">All other features and panels</li>
              </ul>
...
/>
              ...
              <p style="margin-bottom:12px;font-weight:600;">Best for:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;">Simple, focused conversations without distractions</li>
                <li style="margin-bottom:10px;padding-left:8px;">When you don't need AI features or transcriptions</li>
                <li style="margin-bottom:10px;padding-left:8px;">Smaller screens where space is at a premium</li>
                <li style="margin-bottom:10px;padding-left:8px;">Casual meetings that don't require advanced features</li>
                <li style="margin-bottom:0;padding-left:8px;">Users who prefer minimal interface design</li>
              </ul>
        ...
        {
          id: 'how-to-switch-layouts',
          question: 'How do I switch between layout options?',
          answer: `
            <div style="line-height:1.8;color:#374151;font-size:15px;">
              <p style="margin-bottom:20px;">Switching between layout options is quick and easy, allowing you to adapt your workspace on the fly during meetings.</p>
              
              <div style="padding:20px;background:#DBEAFE;border-left:4px solid #2563EB;border-radius:8px;margin-bottom:24px;">
                <p style="margin:0;font-weight:600;color:#1E40AF;font-size:15px;">⚡ INSTANT SWITCHING</p>
                <p style="margin:8px 0 0 0;color:#1E3A8A;font-size:14px;">Change your layout at any time during a meeting to match your current needs—no interruption to your workflow.</p>
              </div>

              <p style="margin-bottom:12px;font-weight:600;">How to switch layouts:</p>
              <ol style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:12px;padding-left:8px;">Locate the <strong>Layout Options</strong> menu in your meeting interface</li>
                <li style="margin-bottom:12px;padding-left:8px;">Click on the Layout selector</li>
                <li style="margin-bottom:12px;padding-left:8px;">Choose from the four available options:
                  <ul style="margin:8px 0 0 0;padding-left:24px;">
                    <li style="margin-bottom:6px;">Full View</li>
                    <li style="margin-bottom:6px;">Focused</li>
                    <li style="margin-bottom:6px;">Convo + AI</li>
                    <li style="margin-bottom:0;">Chat Only</li>
                  </ul>
                </li>
                <li style="margin-bottom:0;padding-left:8px;">Your workspace instantly updates to the selected layout</li>
              </ol>

              

              <p style="margin-bottom:12px;font-weight:600;">Layout switching tips:</p>
              <ul style="margin:0 0 24px 0;padding-left:24px;">
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Start with Full View:</strong> Get familiar with all features</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Switch during meetings:</strong> Adapt layout as meeting phases change</li>
                <li style="margin-bottom:10px;padding-left:8px;"><strong>Match to task:</strong> Use Focused for active chat, Full View for monitoring</li>
                <li style="margin-bottom:0;padding-left:8px;"><strong>Consider screen size:</strong> Smaller screens benefit from Chat Only or Convo + AI</li>
              </ul>

              <p style="margin:0;padding:16px;background:#f9fafb;border-left:3px solid #2563EB;border-radius:4px;font-size:14px;">
                <strong>Pro Tip:</strong> Experiment with different layouts to find what works best for your meeting style and screen setup.
              </p>
            </div>
          `
        }
          ...
          <div key={item.id} style={{ marginBottom: '12px' }}>
            <button
              onClick={() => {
                ...
                if (firstQuestion) {
                  setSelectedArticle(firstQuestion.id); // open content directly
                } else {
              ...
              style={{
                ...
                backgroundColor:
                  ...
                  item.questions?.some((q) => q.id === selectedArticle)
                    ? '#DBEAFE'
                    : 'transparent',
                border: 'none',
                borderRadius: '6px',
    ...
    >
      ...
      Back to Dashboard
        ...
        <div style={{ textAlign: 'center', marginBottom: '30px' }}>
          <h1 style={{ fontSize: '36px', fontWeight: 700, color: '#111827', marginBottom: '10px', lineHeight: '1.1' }}>
