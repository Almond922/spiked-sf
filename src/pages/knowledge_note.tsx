...
import { 
    ...
    Users,
    X,
    BookOpen, // Added for the Article
    FileText, // Added for the Article
} from 'lucide-react';
...
const NoteTakerArticle: FC<NoteTakerArticleProps> = ({ onBack }) => {
    return (
        <div className="flex h-screen w-full bg-white overflow-hidden text-gray-900 justify-center">
            ...
            <div className="flex-grow max-w-4xl pt-12 pb-12 overflow-y-auto">
                <div className="bg-white p-8 rounded-lg">
                    ...
                    <div className="mb-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                            <li>
                                **For Scheduled Meetings:** Ensure the SpikedAI bot is invited to the calendar event. It will automatically join and start transcribing when the meeting begins.
                            </li>
                            <li>
                                **For Ad-Hoc Meetings:** Copy the meeting URL from your conferencing software (e.g., Google Meet URL) and paste it into the **"Connect Meet"** field in your SpikedAI dashboard.
                            </li>
                        </ul>
                        <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg text-sm text-red-800">
                            **Tip:** Always check that **"Live Transcription"** is active (Green indicator) to ensure the AI is listening.
                        </div>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                            <li>
                                **Pre-built Templates:** Use default options like **"Summary," "Action Items,"** or **"Sentiment Analysis"** for quick, standard reports.
                            </li>
                            <li>
                                **Create Custom Template:** Click the **"Create Custom Template"** button in the left sidebar. This opens a modal where you define a specific **Analysis Prompt** (e.g., "Extract all technical requirements and list them by severity.").
                            </li>
                            <li>
                                **Custom Goals:** Your **Custom Goals** are automatically tracked by the AI in real-time if the information is mentioned during the conversation.
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                            <li>
                                **Ask the Assistant:** Use the chat field in the **AI Assistant** panel to ask follow-up questions about the transcript, like "What were the next steps for the engineering team?"
                            </li>
                            <li>
                                **Share and Save:** Use the **"Share"** or **"Save PDF"** buttons (located near the top of the AI Assistant panel) to distribute the final transcript and analysis report to your team.
                            </li>
                        </ul>
                    </div>
                </div>
...
// ======================================================================
// --- 2. MODAL AND DASHBOARD COMPONENTS (Original Code, Renamed) ---
// ======================================================================

// The rest of the original code follows (CreateTemplateModal, GoalCard, DashboardDemo)
// Only the necessary types/imports/components are included below for brevity and functionality.
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 transform transition-all duration-300 scale-100">
                ...
                <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
                    <div>
                        ...
                        <input type="text" placeholder="e.g., Risk Assessment" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500 text-sm"/>
                    </div>
                    <div>
                        ...
                        <div className="flex gap-3">
                             {themeColors.map(item => (
                                <button
                                    ...
                                    className={`flex items-center space-x-2 p-2 rounded-full text-xs font-medium transition duration-150 ${
                                        selectedColor === item.name 
                                        ? 'ring-2 ring-offset-2 ring-red-500 bg-gray-100' 
                                        : 'hover:bg-gray-50'
                                    }`}
                                >
                                    <span 
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-900 mb-2">Analysis Prompt <span className="text-red-500">*</span></label>
                        <textarea
                            placeholder="Describe exactly what analysis you want the AI to perform..."
                            rows={6}
                ...
                <div className="flex justify-end space-x-3 p-5 border-t border-gray-200">
                    <button onClick={onClose} className="py-2 px-4 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition">Cancel</button>
                    <button onClick={handleCreate} className="flex items-center py-2 px-4 text-sm font-semibold text-white bg-red-600 rounded-lg hover:bg-red-700 transition">
                        <CheckCircle className="w-4 h-4 mr-2" /> Create Template
                    </button>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="flex items-start justify-between p-3 bg-white hover:bg-gray-50 cursor-pointer rounded-lg border border-gray-100 mb-2">
            <div className="flex items-center">
                ...
                <div>
                    <p className="text-sm font-medium text-gray-800 flex items-center">{title} <ChevronDown className="w-3 h-3 ml-1 text-gray-400" /></p>
        ...
        <div className="flex h-screen w-full bg-gray-100 overflow-hidden text-gray-900">
            ...
            <div className="w-72 bg-white border-r border-gray-200 flex flex-col p-4 shadow-md">
                <div className="flex items-center mb-6">
                    <button 
                        onClick={onViewArticle} // ADDED: Button to view the article
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-between cursor-pointer mb-2">
                        <p className="text-xs font-semibold text-gray-500 uppercase">CUSTOM GOALS ({customGoals.length})</p>
                ...
                <div>
                    <div className="flex items-center justify-between cursor-pointer mb-2">
                        <p className="text-xs font-semibold text-gray-500 uppercase">PREBUILT TEMPLATES</p>
                    ...
                    <div className="flex items-start p-3 bg-red-50/50 hover:bg-red-100 cursor-pointer rounded-lg border border-red-200">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">Quickly summarize the meeting highlights, action items, and next steps.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-grow flex flex-col p-6 bg-gray-50 border-r border-gray-200">
                <h1 className="text-xl font-semibold mb-6">Live Transcription</h1>
            ...
            <div className="w-80 bg-white flex flex-col border-l border-gray-200 shadow-md">
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-800 flex items-center">
                        <Zap className="w-5 h-5 text-red-600 mr-2" /> AI Assistant
                    </h2>
                    <div className="flex space-x-2">
                        <button className="flex items-center text-sm text-gray-600 hover:text-red-600 p-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition"><Save className="w-4 h-4 mr-1" /> Save PDF</button>
                        <button className="flex items-center text-sm text-gray-600 hover:text-red-600 p-2 rounded-lg bg-gray-50 hover:bg-gray-100 transition"><Share2 className="w-4 h-4 mr-1" /> Share</button>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-gray-200">
                    <div className="relative flex items-center">
                        <input type="text" placeholder="Ask a question..." className="w-full p-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-500 text-sm"/>
...
// This replaces the MultiStepOnboarding component as the primary entry point
const NoteTakerApp: FC = () => {
    // State to toggle between the Dashboard view and the Article view
    const [view, setView] = useState<'dashboard' | 'article'>('dashboard');

    return (
        <div className="font-inter h-screen w-full">
            {view === 'dashboard' ? (
                // Pass a function to change the view when the button is clicked
                <DashboardDemo onViewArticle={() => setView('article')} />
            ) : (
                // Pass a function to change the view back to the dashboard
