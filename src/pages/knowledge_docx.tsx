...
      <div className="flex justify-start items-center space-x-6 pb-4 border-b border-gray-200 flex-shrink-0">
...
      {/* Chat input */}
      <div className="mt-6 flex flex-col space-y-4 flex-shrink-0">
...
      {/* Empty state (will scroll if content is added) */}
      <div className="flex flex-col items-center justify-center flex-grow text-center text-gray-500 p-8 mt-12 overflow-y-auto">
